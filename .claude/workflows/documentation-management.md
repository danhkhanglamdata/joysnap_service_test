...
- **Project Roadmap** (`./agent-includes/specs/development-roadmap.md`): Living document tracking project phases, milestones, and progress
- **Project Changelog** (`./agent-includes/specs/project-changelog.md`): Detailed record of all significant changes, features, and fixes
- **System Architecture** (`./agent-includes/specs/system-architecture.md`): Technical architecture documentation, component diagrams, and data flow
- **Code Standards** (`./agent-includes/specs/code-standards.md`): Coding conventions, style guides, and best practices for the project
...
### Plan Location
Save plans in `./agent-includes/plans` directory with timestamp and descriptive name.

**Format:** `agent-includes/plans/YYYYMMDD-HHmm-your-plan-name/`

**Example:** `agent-includes/plans/20251101-1505-authentication-and-profile-implementation/`

#### File Organization

```
agent-includes/plans/
...
Fully respect the `./agent-includes/specs/development-rules.md` file.
