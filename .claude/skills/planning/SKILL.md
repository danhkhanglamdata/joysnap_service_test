...
**Skip if:** Provided with codebase-explorer reports
...
└── YYYYMMDD-HHmm-plan-name/
    ...
    │   └── ...
    ├── codebase/
    │   ├── codebase-explorer-XX-report.md
    │   └── ...
    ├── plan.md
...
**Example content:**
```
agent-includes/plans/20251128-1654-fix-agent-coordination
```
...
**Fallback:** If no active-plan file exists, use `agent-includes/plans/reports/`
